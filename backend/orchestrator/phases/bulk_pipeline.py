    ...
    def _run():
        try:
            ...
            try:
                ...
                # 2. Switch IDENTITY columns to GENERATED BY DEFAULT
                id_cols = oracle_browser.switch_identity_to_default(
                    conn, tgt_schema, tgt_table)
                if id_cols:
                    print(f"[orchestrator] {mid}: switched IDENTITY to BY DEFAULT: {id_cols}")
                ...
                # 4. Mark non-PK indexes UNUSABLE
